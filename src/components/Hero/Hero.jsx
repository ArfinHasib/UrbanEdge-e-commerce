                        ...
                        <div className='flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10'>
                           ...
                           >
                              <button
                                 ...
                                 className='text-center mt-10 cursor-pointer bg-primary text-white py-2 px-5 rounded-full font-bold hover:scale-110 transition-all hover:bg-white hover:text-black ml-2'
                              >
                                 Order Now
                              </button>
                           </div>
